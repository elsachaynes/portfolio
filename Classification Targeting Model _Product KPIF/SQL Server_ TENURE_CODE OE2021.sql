/****************************************************************************************************/
/*  Program Name:       SQL Server_ TENURE_CODE OE2021.sql                                          */
/*                                                                                                  */
/*  Date Created:       July 8, 2022                                                                */
/*                                                                                                  */
/*  Created By:         Elle Haynes                                                                 */
/*                                                                                                  */
/*  Purpose:            Calculates tenure (prior to OE2021) for the KPIF EM OE 2023 Targeting model.*/
/*                                                                                                  */
/*  Inputs:                                                                                         */
/*                                                                                                  */
/* -------------------------------------------------------------------------------------------------*/	
...
WHERE YEAR(PROMO_START_DT)=2020 -- ONLY OE2021
GROUP BY 
	AGLTY_INDIV_ID
...
INTO WS_EHAYNES.dbo.KPIF_EM_22_Targeting_Tenure_OE21 --FILE OUTPUT
FROM #SUM 
...
SELECT TOP 100 * FROM WS_EHAYNES.dbo.KPIF_EM_22_Targeting_Tenure_OE21 --SELECT FILE FOR VIEWING