/****************************************************************************************************/
/*  Program Name:       SQL Server_ TENURE_CODE OE2022.sql                                          */
/*                                                                                                  */
/*  Date Created:       July 8, 2022                                                                */
/*                                                                                                  */
/*  Created By:         Elle Haynes                                                                 */
/*                                                                                                  */
/*  Purpose:            Calculates tenure (prior to OE2022) for the KPIF EM OE 2023 Targeting model.*/
/*                                                                                                  */
/*  Inputs:                                                                                         */
/*                                                                                                  */
/* -------------------------------------------------------------------------------------------------*/	
...
WHERE YEAR(PROMO_START_DT)=2021 -- ONLY OE2022
GROUP BY 
	AGLTY_INDIV_ID
...
INTO WS_EHAYNES.dbo.KPIF_EM_22_Targeting_Tenure_OE22 --FILE OUTPUT
FROM #SUM 
...
SELECT TOP 100 * FROM WS_EHAYNES.dbo.KPIF_EM_22_Targeting_Tenure_OE22 --SELECT FILE FOR VIEWING

SELECT 
	'OE 2020' AS OE_SEASON, AGLTY_INDIV_ID, TENURE_YEARS, TENURE_MONTHS, TENURE_DAYS 
INTO WS_EHAYNES.dbo.KPIF_EM_22_Targeting_Tenure
FROM WS_EHAYNES.dbo.KPIF_EM_22_Targeting_Tenure_OE20
	UNION
SELECT 
	'OE 2021' AS OE_SEASON, AGLTY_INDIV_ID, TENURE_YEARS, TENURE_MONTHS, TENURE_DAYS 
FROM WS_EHAYNES.dbo.KPIF_EM_22_Targeting_Tenure_OE21
	UNION
SELECT 
	'OE 2022' AS OE_SEASON, AGLTY_INDIV_ID, TENURE_YEARS, TENURE_MONTHS, TENURE_DAYS 
FROM WS_EHAYNES.dbo.KPIF_EM_22_Targeting_Tenure_OE22

SELECT COUNT(*) FROM WS_EHAYNES.dbo.KPIF_EM_22_Targeting_Tenure